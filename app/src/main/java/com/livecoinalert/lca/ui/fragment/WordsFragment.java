...
import com.livecoinalert.lca.ui.activity.NavigationActivity;
...
public class WordsFragment extends BaseMenuFragment implements SingleObserver<List<DemoItem>> {
...
/*        if (this.keyword != null) {
    ...
    private void addWords() {
        ...
        if (activity instanceof NavigationActivity) {
            //((NavigationActivity) activity).goTools();
        }
    }
